...
8. The executor performs the predefined action.
9. The execution result is recorded in the healing audit log.
...
4. The target cache directory exists.
5. The target path is a directory.
